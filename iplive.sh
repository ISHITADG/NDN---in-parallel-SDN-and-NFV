...
for (( i=0; i<$answer; i++ )); do
  docker exec -w /AStream/dist/client ndn$i python /AStream/dist/client/dash_client.py -m http://10.10.1.1/www-itec.uni-klu.ac.at/ftp/datasets/DASHDataset2014/BigBuckBunny/2sec/BigBuckBunny_2s.mpd -p bola &
done
