...
num_of_rebuffers = []
spectrum_array = []
DASH_BUFFER_FILENAME=glob.glob("/users/ishitadg/NDNO/DASH_BUFFER/DASH_BUFFER*")
#'<Absolute path of file, e.g /Users/10runs_sara_v*/dash_buffer*/DASH_BUFFER*>'
SERVER_LOG_FILENAME=glob.glob("/users/ishitadg/NDNO/BOLA_LOG/BOLA_LOG*")
...
with open('abr_rebuffers_20Qualities-parallelIPforNDNO.csv', 'w') as f:
    writer = csv.writer(f)
...
with open('abr_numofswitches_20Qualities-parallelIPforNDNO.csv', 'w') as f:
    writer = csv.writer(f)
...
with open('abr_fullcap_rate_20Qualities-parallelIPforNDNO.csv', 'w') as f:
    writer = csv.writer(f)
    writer.writerow(bitrate_array)
f.close()

with open('abr_spectrum_20Qualities-parallelIPforNDNO.csv', 'w') as f:
    writer = csv.writer(f)
