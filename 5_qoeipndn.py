...
num_of_rebuffers = []
spectrum_array = []
DASH_BUFFER_FILENAME=glob.glob("/users/ishitadg/IPNDN/DASH_BUFFER/DASH_BUFFER*")
#'<Absolute path of file, e.g /Users/10runs_sara_v*/dash_buffer*/DASH_BUFFER*>'
SERVER_LOG_FILENAME=glob.glob("/users/ishitadg/IPNDN/BOLA_LOG/BOLA_LOG*")
...
def spectrum_calc(bitrate_history):
	...
	bitrates = bitrates = [1546902.0, 3526922.0, 89283.0, 221600.0, 262537.0, 791182.0, 334349.0, 595491.0, 1244778.0, 131087.0,178351.0, 2484135.0,1032682.0, 4219897.0]
	q_layer = []
	br_qlayer = {}
