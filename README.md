...
tc filter add dev enp9s4f0 parent 1: protocol ip prio 1 u32 match ip src 10.10.1.2 match ip dst 10.10.3.1 flowid 1:12 <br/>
...
tc filter add dev enp5s0f1 parent 1: protocol ip prio 1 u32 match ip src 10.10.3.1 match ip dst 10.10.1.2 flowid 1:12  <br/>
>>OTHERS <br/>
